...
horizontal_pady = pad_str % ('top/bottom', 'horizont')

vertical_padx_l = pad_str % ('left', 'vertic')
vertical_padx_r = pad_str % ('right', 'vertic')
vertical_pady_l = pad_str % ('top', 'vertic')
vertical_pady_r = pad_str % ('bottom', 'vertic')

horizontal_padx_l = pad_str % ('left', 'horizont')
